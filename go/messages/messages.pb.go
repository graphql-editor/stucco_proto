...
type FieldResolveRequest struct {
	...
	SubscritpionPayload *Value            `protobuf:"bytes,7,opt,name=subscritpionPayload,proto3" json:"subscritpionPayload,omitempty"`
}
...
func (x *FieldResolveRequest) GetSubscritpionPayload() *Value {
	if x != nil {
		return x.SubscritpionPayload
	}
	return nil
}
...
var file_messages_messages_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x74, 0x70, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c,
	...
	0x65, 0x52, 0x13, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x74, 0x70, 0x69, 0x6f, 0x6e, 0x50,
...
var file_messages_messages_proto_depIdxs = []int32{
	...
	2,   // 34: stucco.messages.FieldResolveRequest.subscritpionPayload:type_name -> stucco.messages.Value
